...
import { useGetActorsDetailsQuery, useGetMoviesActorIdQuery } from '../../services/TMDB';
...
const Actors = () => {
  ...
  const { data: movies } = useGetMoviesActorIdQuery({ id, page });
    ...
    <>
      <Grid container spacing={3}>
        ...
        <Grid item lg={7} xl={8} style={{ display: 'flex', justifyContent: 'center', flexDirection: 'column' }}>
          ...
          <Typography variant='body1' align='justify' paragraph style={{ textIndent: '1.5rem' }}>
